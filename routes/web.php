...
// Perbaikan: Gunakan penamaan name() yang konsisten
...
Route::post('/payments/midtrans-notification', [App\Http\Controllers\PaymentNotificationController::class, 'handle'])->name('midtrans.notification');
